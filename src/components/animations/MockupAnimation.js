...
const Wrapper = styled.div`
  ...
  * {
  ...
  .mockup1 {
    ...
    background: url("/images/pics/pass_count_ui.png"),
      radial-gradient(
  ...
  .mockup2 {
    ...
    background: url("/images/pics/sim.png"),
      linear-gradient(
        198.85deg,
        #4316db 12.72%,
        #9076e7 54.49%,
  ...
  .mockup3 {
    ...
    background: url("/images/pics/auto.png"), rgba(23, 12, 61, 0.5);
    background-size: cover;
  ...
  .mockup4 {
    ...
    background: url("/images/pics/safety.png"), rgba(39, 20, 62, 0.3);
    background-size: cover;
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px);
    /* Note: backdrop-filter has minimal browser support */
  ...
  .mockup5 {
    ...
    background: url("/images/pics/3d_view.png"), rgba(39, 20, 62, 0.2);
    background-size: cover;
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px);
    /* Note: backdrop-filter has minimal browser support */
